  // src/screens/HomeScreen.tsx (UPDATED WITH AUTH)
...
import Add from '../../assets/icons/icon_newTask.svg';
  ...
  const HomeScreen = ({ navigation }: Props) => {
    ...
    const { level, streak, incrementXP, xp } = useUserStore();
    ...
    useEffect(() => {
    // Check for streak warning every time the screen comes into focus
    // This runs when user opens the app in the evening
    ...
    // Display name: logged user name or "Guest"
